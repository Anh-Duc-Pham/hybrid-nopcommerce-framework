...
public class RegisterPageUI {
    ...
    public static final String PASSWORD_VALIDATION_ERROR_MSG = "//span[@class='field-validation-error']";
    public static final String CONFIRM_PASSWORD_ERROR_MSG = "//span[@id='ConfirmPassword-error']";
    public static final String REGISTRATION_COMPLETED_MSD = "//div[@class='result']";
