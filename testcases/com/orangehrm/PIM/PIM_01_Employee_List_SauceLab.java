...
public class PIM_01_Employee_List_SauceLab extends BaseTest {
    ...
    private String browserName, osName, employeeID, firstName, lastName;
    ...
    public void beforeClass(String serverName, String osName, String browserName, String browserVersion) {
        ...
        this.osName = osName;
        driver = getBrowserDriverSaucelab(enviromentConfig.appUrl(), osName, browserName, browserVersion);
